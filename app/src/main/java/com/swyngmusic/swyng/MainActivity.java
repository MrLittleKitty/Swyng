...
public class MainActivity extends Activity implements
    ...
    @SuppressWarnings("SpellCheckingInspection")
    private static final String SONG_URI = "spotify:track:6KywfgRqvgvfJc3JRwaZdZ";
    @SuppressWarnings("SpellCheckingInspection")
    private static final String SONG_MONO_URI = "spotify:track:1FqY3uJypma5wkYw66QOUi";
    @SuppressWarnings("SpellCheckingInspection")
    private static final String SONG_48kHz_URI = "spotify:track:3wxTNS3aqb9RbBLZgJdZgH";
    @SuppressWarnings("SpellCheckingInspection")
    private static final String PLAYLIST_URI = "spotify:user:spotify:playlist:2yLXxKhhziG2xzy7eyD4TD";
    @SuppressWarnings("SpellCheckingInspection")
    private static final String ALBUM_URI = "spotify:album:2lYmxilk8cXJlxxXmns1IU";
    @SuppressWarnings("SpellCheckingInspection")
    private static final String QUEUE_SONG_URI = "spotify:track:5EEOjaJyWvfMglmEwf9bG3";
    ...
    public void onQueueSongButtonClicked(View view) {
        mPlayer.queue(mOperationCallback, QUEUE_SONG_URI);
